                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <li><a class="dropdown-item" href="{{url("/sanpham")}}">Tất cả sản phẩm</a></li>
                   ...
                   @foreach ($data as $item)
                    ...
                    <div class="col mb-5">
                        <div class="card h-100">
                            <!-- Product image-->
                            <img class="card-img-top" src="{{url("storage/product-img/$item->anh")}}" alt="..." />
                            <!-- Product details-->
